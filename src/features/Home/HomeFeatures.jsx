                    ...
                    <div className='w-full min-w-[305px]'>
                      ...
                      <div className='flex'>
                        ...
                        <div className='block text-end w-full gap-4 mt-8'>
                          <span className='block text-end font-bold text-lg'>${i.amount/1000000}</span>
                          <span className='text-[14px]'>From {i.user}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='w-full min-w-[305px]'>
                      ...
                      <div className='flex'>
                        <div className='flex items-center w-full gap-4 mt-8'>
                          ...
                          <div className='grid'>
                            <span className='font-bold text-lg'>Withdrawals</span>
                            {/* <span className='text-[14px]'>Shopping</span> */}
                          </div>
                        </div>
                        <div className='block text-end w-full gap-4 mt-8'>
